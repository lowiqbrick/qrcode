...
mod tests {
    ...
    fn exampletest() {
        ...
        let data = Polynomial::new(vec![
            Indeterminate::new(0x41_u8 as i8, 18),
            Indeterminate::new(0x14_u8 as i8, 17),
            Indeterminate::new(0x86_u8 as i8, 16),
            Indeterminate::new(0x56_u8 as i8, 15),
            Indeterminate::new(0xc6_u8 as i8, 14),
            Indeterminate::new(0xc6_u8 as i8, 13),
            Indeterminate::new(0xf2_u8 as i8, 12),
            Indeterminate::new(0xc2_u8 as i8, 11),
            Indeterminate::new(0x07_u8 as i8, 10),
            Indeterminate::new(0x76_u8 as i8, 9),
            Indeterminate::new(0xf7_u8 as i8, 8),
            Indeterminate::new(0x26_u8 as i8, 7),
            Indeterminate::new(0xc6_u8 as i8, 6),
            Indeterminate::new(0x42_u8 as i8, 5),
            Indeterminate::new(0x12_u8 as i8, 4),
            Indeterminate::new(0x03_u8 as i8, 3),
            Indeterminate::new(0x13_u8 as i8, 2),
            Indeterminate::new(0x23_u8 as i8, 1),
            Indeterminate::new(0x30_u8 as i8, 0),
        ]);
        println!("data raw:\n{}", data);
        let x_7 = Polynomial::new(vec![Indeterminate::new(1, 7)]);
        let data_raised = data * x_7;
        println!("data raised:\n{}", data_raised);
        // modulo
        let galois_field = GaloisFields::new(
            8,
            Polynomial::new(vec![
        ...
        // println!("{}", galois_field);
        let g_x = galois_field.correction_polynomial(7).unwrap();
        let data_divided = data_raised / g_x;
        println!("data divided:\n{}", data_divided);
        for indeterminate in data_divided.function.clone().iter() {
            println!(
                "coefficient {} (degree: {}) became {:02x}",
                indeterminate.coefficient,
                indeterminate.degree,
                galois_field.get_alpha(indeterminate.coefficient as u8)
            )
        }
        panic!();
    }
